...
export const AboutDetails = () => {
    return(
        <div className=" w-full lg:w-[60%] h-[93%]  flex flex-col justify-between gap-3 md:gap-0">
            ...
            <Paragraph content="We are a global construction company delivering innovative, high-quality, and sustainable solutions. From towers to infrastructure, we shape cities, empower communities, and set new standards for the industry." className="tracking-widest  text-lg  text-gray-600 md:max-w-3xl mx-auto leading-relaxed"/>
            <CompanyHighlights/>
        </div>
    )
}