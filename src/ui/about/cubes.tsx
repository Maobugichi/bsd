import { Settings, Building2, UserCheck, CircuitBoard, ArrowRight } from 'lucide-react';
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className={`
                    ...
                    ${colors.iconBg}
                  `}>
                    <ArrowRight className={`w-4 h-4 ${colors.iconColor} transition-colors duration-300`} />
                  </div>
                </div>
              </div>
