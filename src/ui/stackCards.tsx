...
const cards:CardStackProps[] = [
  {
    ...
    children: (
      <div className="p-6 flex flex-col h-full gap-3 md:gap-5">
        <div className="grid gap-3">
          <h1 className="text-xl md:text-3xl font-semibold mb-3 text-white">Reliable and Transparent</h1>
          <p className="font-roboto text-sm md:text-lg leading-relaxed text-[#ccc]">
        ...
        <div className="w-12 h-12 md:w-14 md:h-14 grid place-items-center border-2 rounded-full bg-[#2D5C52] mt-4">
  ...
  },
  {
    ...
    children: (
      <div className="p-6 flex flex-col h-full gap-3 md:gap-5">
        ...
        <div className="w-12 h-12 md:w-14 md:h-14 grid place-items-center border-2 rounded-full bg-[#C47A00] mt-4">
    ...
    children: (
      <div className="p-6 flex flex-col h-full gap-3 md:gap-5">
        <div>
          ...
          <p className="font-roboto text-sm md:text-lg leading-relaxed text-gray-700">
        ...
        <div className="w-12 h-12 md:w-14 md:h-14 grid place-items-center border-2 rounded-full bg-black mt-4">
...
export const StackedCards = () => {
    ...
    return(
        <div ref={constraintsRef} className=" relative  w-[95%] md:w-full h-fit  min-h-[60vh] grid  md:h-96 mx-auto mt-20 ">
            {
                cardStack.map((card:CardStackProps,index:number) => {
                    ...
                    return(
                         <motion.div
                            key={card.className}
                            className={`absolute w-full h-[90%] rounded-2xl shadow-xl cursor-pointer flex items-center justify-center text-xl font-bold ${card.className} ${isTop ? 'opacity-100' : 'opacity-75'}`}
                            style={{
                                zIndex:z,
                                top:index * -20,
                                scale:1 - index * 0.04
