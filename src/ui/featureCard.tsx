       ...
       const services = [
            {
                ...
                <div className="p-4">
                    ...
                    <p>We deliver expert construction and maintenance services, ensuring strong, durable structures with ongoing support for reliability and efficiency.</p>
            ...
            },
            {
                ...
                <div className="p-4">
                    ...
                    <p>We offer cloud, VoIP, cybersecurity, and network solutions to keep your business connected, protected, and productive.</p>
            ...
            },
            {
                ...
                <div className="p-4">
                    ...
                    <p>From sourcing to shipping, we streamline international trade with reliable import, export, and product sales operations.</p>
            ...
            },
            {
                ...
                <div className="p-2">
                    ...
                    <p className="text-sm">From design to delivery, we develop high-quality residential and commercial real estate.</p>
            ...
            },
            {
                ...
                <div className="p-2">
                    ...
                    <p className="text-sm">Upgrade residential or commercial spaces with modern, value-enhancing transformations.</p>
