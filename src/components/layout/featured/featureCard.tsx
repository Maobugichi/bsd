...
const FeatureRow = ({ item, index, isOpen, onToggle }: FeatureRowProps) => {
    ...
    return (
        <li>
            {/* Toggle trigger — button only wraps the interactive header */}
            <button
                onClick={onToggle}
            ...
            {/* Expandable content — sibling of button, not inside it */}
            ...
            <ul className="flex flex-col divide-y divide-white/10">
                {features.map((item, i) => (
                    <motion.div
                        ...
                        // div wrapper so motion doesn't break the ul > li structure
