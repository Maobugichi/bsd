        ...
        <div className=" w-full lg:w-[70%] [@media(min-width:1020px)_and_(max-width:1024px)]:w-[90%]  flex flex-col  justify-between gap-10">
            <div className=" mx-auto w-full grid space-y-4">
             <ShimmerBadge text="About Us" icon={Info} width="w-32"/>
              ...
              <Paragraph content="We are a global construction company delivering innovative, high-quality, and sustainable solutions. From towers to infrastructure, we shape cities, empower communities, and set new standards for the industry." className="text-gray-600 font-roboto" />
            </div>
